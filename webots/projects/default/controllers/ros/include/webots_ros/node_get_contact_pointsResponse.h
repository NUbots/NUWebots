...
struct node_get_contact_pointsResponse_
{
  ...
  node_get_contact_pointsResponse_(const ContainerAllocator& _alloc)
   ...
   typedef std::vector< ::webots_ros::ContactPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::webots_ros::ContactPoint_<ContainerAllocator> >::other >  _contact_points_type;
