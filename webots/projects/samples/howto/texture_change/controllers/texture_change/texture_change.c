...
int main() {
  ...
  while (wb_robot_step(TIME_STEP) != -1) {
    if (i++ == 30) { /* when the counter reaches 30, we change the texture. */
      if (j++ % 2)
        text = "https://raw.githubusercontent.com/cyberbotics/webots/R2022b/projects/default/worlds/textures/stone.jpg";
      else
        text = "https://raw.githubusercontent.com/cyberbotics/webots/R2022b/projects/default/worlds/textures/lightwood.jpg";
